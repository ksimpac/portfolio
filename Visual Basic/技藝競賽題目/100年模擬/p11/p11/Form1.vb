Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        For i = 1 To 1
            Dim filereader As String = My.Computer.FileSystem.ReadAllText(".\in1-1.txt", System.Text.Encoding.Default)
            Call y(filereader)
        Next
    ...
    Sub y(ByVal filereader As String)
        ...
        For i = 0 To UBound(array1)
            ...
            My.Computer.FileSystem.WriteAllText(".\out1-1.txt", flag & vbCrLf, True)
