Public Class Form1
    ...
    Sub y(ByVal fn As Integer)
        ...
        Dim root As Integer = btree(1) : Call Postorder_Traversal(btree(2))
        Call Postorder_Traversal(btree(3)) : node.Add(root)
    ...
    End Sub
    Sub Postorder_Traversal(ByRef now_root As Integer)

        For i = 0 To UBound(path)

            If path(now_root, i) = 1 Then
                Call Postorder_Traversal(i)
        ...
        If flag = True Then node.Add(now_root) : flag = False
